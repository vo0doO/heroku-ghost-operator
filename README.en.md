...
> Notice: If you are getting a Heroku policy error please refer to this [discussion](https://github.com/vo0doo/heroku-ghost-operator/discussions/24).
...
If the above button does not work for you, disable anything that might be blocking Heroku from inferring the referrer (e.g. Brave shield), or try this: https://heroku.com/deploy?template=https://github.com/vo0doo/heroku-ghost-operator (if you're using a fork, make sure to point the template link to your repo).
...
- [Open an Issue](https://github.com/vo0doo/heroku-ghost-operator/issues/new/)
- [Use GitHub Discussions](https://github.com/vo0doo/heroku-ghost-operator/discussions)

### License
Released under the [MIT license](https://github.com/vo0doo/heroku-ghost-operator/blob/main/LICENSE), just like the Ghost project itself.
